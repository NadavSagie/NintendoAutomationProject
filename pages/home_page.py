...
class HomePage(BasePage):
    ...
    _CHANGE_LANGAUGE_COUNTRIES_LIST = ".category-list > li"
    ...
    def click_selected_language(self, country_name):
        country_locator = self.page.locator(self._CHANGE_LANGAUGE_COUNTRIES_LIST, has_text=country_name)
        country_locator.first.click()
